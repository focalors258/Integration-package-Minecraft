StartupEvents.registry('entity_type', event => {
    ...
    event.create('split_crystal', "entityjs:geckolib_projectile")
        // .immuneTo()//可接受的方块
        ...
        .tick(entity => {
            ...
            if (entity.getRootData().contains("goal")) {//追踪false


                let entity1 = entity.level.getEntity(entity.getRootData().getString('goal'))
                ...
                if (distance < 1) {
                    ...
                    if (entity.areData("att")) {
                        
                        attack(entity,entity1,"air",entity.getDataFloat("att"),0)
