...
let getWeaponStack = (player) => {


    return player.getWeaponStack(getPlayerWeapon(player).id)
...
ServerEvents.tags("item", e => {
    ...
    e.add("kubejs:combat_weapon", "cataclysm:the_incinerator")
    e.add("kubejs:combat_weapon", "minecraft:diamond_sword")
    e.add("kubejs:combat_weapon", "spartanweaponry:invar_javelin")
    e.add("kubejs:combat_weapon", "spartanweaponry:platinum_tomahawk")
    //  e.add("kubejs:combat_weapon", "spartanweaponry:netherite_rapier")

    spartanSuit.forEach((k, i) => {

        spartanKind.forEach(w => {

            console.log(Item.of(k + "_" + w))
            e.add("kubejs:combat_weapon", k + "_" + w)
        })
